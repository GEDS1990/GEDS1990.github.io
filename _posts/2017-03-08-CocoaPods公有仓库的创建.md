...
> 本文发布于 [GEDS Blog](http://geds.github.io)、[简书](http://www.jianshu.com/p/d2d98298b1b8) 转载请保留链接
...
下面我们将一步步把我封装的这个简单的TextFiled控件 [BYPhoneNumTF](https://github.com/geds/BYPhoneNumTF) 上传到 Cocoapods 公有仓库中。
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/geds/BYPhoneNumTF" # 你的主页
  s.source       = { :git => "https://github.com/geds/BYPhoneNumTF.git", :tag => "#{s.version}" }#你的仓库地址，不能用SSH地址
  ...
  # User
  s.author             = { "BY" => "gedsios@163.com" } # 作者信息
  s.social_media_url   = "http://geds.github.io" # 个人主页
...
但是很多情况没这么顺利，比如:
	 ...
	 -> BYPhoneNumTF (1.0.0)
	    - WARN  | url: There was a problem validating the URL http://geds.github.io.
...
---
	-> BYPhoneNumTF (1.0.0)
	   ...
	   - Homepage: https://github.com/geds/BYPhoneNumTF
	   - Source:   https://github.com/geds/BYPhoneNumTF.git
